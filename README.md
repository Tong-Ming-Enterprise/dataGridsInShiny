...
- [Handsontable](https://handsontable.com), and
- [Handsontable version 6.2.2] an older version with an MIT license.

The above packages each have their own licenses.  *You need to ensure you are licensed to use the grids!*. Any code that I write here to integrate the grids into sample Shiny apps is released with an MIT license.
