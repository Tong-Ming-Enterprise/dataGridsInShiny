...
#https://www.geeksforgeeks.org/convert-dataframe-to-list-of-vectors-in-r/
#list = as.list(sampledf)
...
server <- function(input, output, session) {
	...
	columnDefs <- list(
		...
		list(headerName = "Date", field = 'p_date', cellClass = 'dateType', editable = TRUE, singleClickEdit = TRUE, width = 240),
		...
		list(headerName = "Note", field = "note", singleClickEdit = TRUE, cellEditor = 'agLargeTextCellEditor', cellEditorPopup = TRUE, cellEditorParams = list(maxLength = 100,rows = 10, cols = 50))
